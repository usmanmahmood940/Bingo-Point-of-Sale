...
export class WidgetsDropdownComponent implements OnInit, AfterContentInit {
  ...
  getAllValues() {
    this.apiService.getTotalSales().subscribe(
      (response) => {
        ...
        if (response != null && response != undefined) {
          this.chartValues.totalSale = response.total.toString();
        }
        else {
    ...
    this.apiService.getTotalExpenses().subscribe(
      (response) => {
        if (response != null && response != undefined) {
          this.chartValues.totalExpenses = response.total.toString();
        }
        else {
          // this.isLoading = false;
        }
    ...
    this.apiService.getCategoryList().subscribe(
      (response) => {
        if (response != null && response != undefined) {
          this.chartValues.totalCategories = response.totalCategories.toString();
        } else {
          // this.isLoading = false;
        }
      },
     ...
     this.apiService.getProductList().subscribe(
       (response) => {
         if (response != null && response != undefined) {
           this.chartValues.totalProducts =
             response.totalProducts.toString();
         } else {
           // this.isLoading = false;
         }
       },
